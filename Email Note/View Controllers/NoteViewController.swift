...
//                self.sendingLabel.text = "Please validate your email:\n\(invalidEmails.first ?? "")"
//                if invalidEmails.count > 1 {
//                    self.sendingLabel.text = "Please validate your emails"
//                }
//                self.sendingProgress.setProgress(0, animated: false)
//                self.sendingProgress.isHidden = true
//                self.sending = false
//                DispatchQueue.main.asyncAfter(deadline: .now() + 10) {
//                    self.showSending = false
//                    self.sendingProgress.isHidden = true
//                    self.bottomView(show: false)
...
//                            self.sendingProgress.setProgress(((Float(index + 1) * 0.85) / Float(User.emails.count)), animated: true)
//                            req.downloadProgress { progress in
//                                self.sendingProgress.setProgress(Float((index + 1) / User.emails.count), animated: true)
//                            }
//                            req.response { response in
//                                if response.error != nil || response.response == nil {
//                                    self.sendingLabel.text = "Uh oh! Looks like there was an issue sending!"
//                                } else {
...
//                                        // If it is the first email, record it as sent
//                                        if index == 0 {
//                                            Emails.sent()
//                                        }
//                                        break
...
//                            self.sendingLabel.text = "Please type a note to send to\nyour emails"
//                        } else {
//                            self.sendingLabel.text = "Please type a note to send to:\n" + User.mainEmail
//                        }
//                        self.sendingProgress.isHidden = true
